...
- Bachelor's Degree
  ...
  - Year 2 (CC, 2021 - 2022)
    ...
    - Design of Algorithms (PA, prof. Costin Chiru)
      - [Project](https://github.com/Catalin-Ripanu/Halite_Bot)
      - [Homework1](https://github.com/Catalin-Ripanu/Algo_Problems_Set_I)
      - [Homework2](https://github.com/Catalin-Ripanu/Algo_Problems_Set_II)
    - Programming Paradigms (PP, prof. Andrei Olaru)
      - [Homework1](https://github.com/Catalin-Ripanu/Racket_Pythagorean_Triples)
      - [Homework2](https://github.com/Catalin-Ripanu/Haskell_Graph_Zoo)
      - [Homework3](https://github.com/Catalin-Ripanu/Prolog_Ultimate_Tic_Tac_Toe)
    - Networking Communication Protocols (PCom, prof. Ciprian Dobre)
      - [Homework1](https://github.com/Catalin-Ripanu/Router)
      - [Homework2](https://github.com/Catalin-Ripanu/Application_Protocol)
      - [Homework3](https://github.com/Catalin-Ripanu/REST_API_Client_Server)
